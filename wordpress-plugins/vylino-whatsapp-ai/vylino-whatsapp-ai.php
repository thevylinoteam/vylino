...
define( 'VYLINO_WA_VERSION', '0.2.0' );
...
require_once VYLINO_WA_DIR . 'includes/class-vylino-wa-gemini-provider.php';
...
function vylino_wa_bootstrap(){static $core=null;if(null===$core){$core=new Vylino_WA_Core();$core->boot();}return $core;}
