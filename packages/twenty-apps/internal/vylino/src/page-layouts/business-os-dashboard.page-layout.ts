...
import {
  ...
  VylinoMarketingPeriod,
  VylinoMarketingProvider,
  VylinoMarketingScope,
...
const marketing30DaySummaryFilter = {
  recordFilters: [
    {
      fieldMetadataUniversalIdentifier: VYLINO_MARKETING_PROVIDER_FIELD_ID,
      operand: 'IS',
      value: `["${VylinoMarketingProvider.ALL}"]`,
    },
    {
      fieldMetadataUniversalIdentifier: VYLINO_MARKETING_PERIOD_FIELD_ID,
      operand: 'IS',
      value: `["${VylinoMarketingPeriod.LAST_30_DAYS}"]`,
    },
    {
      fieldMetadataUniversalIdentifier: VYLINO_MARKETING_SCOPE_FIELD_ID,
      operand: 'IS',
      value: `["${VylinoMarketingScope.ACCOUNT}"]`,
    },
  ],
};

const marketing30DayCampaignFilter = {
  recordFilters: [
    {
      fieldMetadataUniversalIdentifier: VYLINO_MARKETING_PERIOD_FIELD_ID,
      operand: 'IS',
    ...
    },
    {
      fieldMetadataUniversalIdentifier: VYLINO_MARKETING_SCOPE_FIELD_ID,
      operand: 'IS',
      value: `["${VylinoMarketingScope.CAMPAIGN}"]`,
    },
  ],
};
...
export default definePageLayout({
  ...
  tabs: [
    ...
    {
      universalIdentifier: 'db469e6b-2a41-4a7c-8ce1-1771100febdc',
      ...
      widgets: [
        {
          universalIdentifier: 'fe65dd7e-aeae-4aa5-8398-da904374a16f',
          title: 'Spend · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
          position: { layoutMode: PageLayoutTabLayoutMode.GRID, row: 0, column: 0, rowSpan: 2, columnSpan: 2 },
          configuration: {
            configurationType: 'AGGREGATE_CHART',
            aggregateFieldMetadataUniversalIdentifier: VYLINO_MARKETING_SPEND_FIELD_ID,
            aggregateOperation: AggregateOperations.SUM,
            displayDataLabel: true,
            timezone: 'Asia/Kolkata',
            firstDayOfTheWeek: 1,
            filter: marketing30DaySummaryFilter,
          },
        },
        {
          universalIdentifier: '0877351b-b86e-45db-82ad-779a6e6c4a4c',
          title: 'Leads · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
          position: { layoutMode: PageLayoutTabLayoutMode.GRID, row: 0, column: 2, rowSpan: 2, columnSpan: 2 },
          configuration: {
            configurationType: 'AGGREGATE_CHART',
            aggregateFieldMetadataUniversalIdentifier: VYLINO_MARKETING_LEADS_FIELD_ID,
            aggregateOperation: AggregateOperations.SUM,
            displayDataLabel: true,
            timezone: 'Asia/Kolkata',
            firstDayOfTheWeek: 1,
        ...
        {
          universalIdentifier: '561f0730-57ce-4114-a81e-be713dc4c98b',
          title: 'Revenue · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
          position: { layoutMode: PageLayoutTabLayoutMode.GRID, row: 0, column: 4, rowSpan: 2, columnSpan: 2 },
          configuration: {
            configurationType: 'AGGREGATE_CHART',
            aggregateFieldMetadataUniversalIdentifier: VYLINO_MARKETING_REVENUE_FIELD_ID,
            aggregateOperation: AggregateOperations.SUM,
            displayDataLabel: true,
            timezone: 'Asia/Kolkata',
            firstDayOfTheWeek: 1,
        ...
        {
          universalIdentifier: '07a87003-1d56-43e0-a212-a76a515de09d',
          title: 'CPL · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
          position: { layoutMode: PageLayoutTabLayoutMode.GRID, row: 0, column: 6, rowSpan: 2, columnSpan: 2 },
          configuration: {
            configurationType: 'AGGREGATE_CHART',
            aggregateFieldMetadataUniversalIdentifier: VYLINO_MARKETING_CPL_FIELD_ID,
            aggregateOperation: AggregateOperations.SUM,
            displayDataLabel: true,
            timezone: 'Asia/Kolkata',
            firstDayOfTheWeek: 1,
        ...
        {
          universalIdentifier: '3338e164-2bf1-4a45-a8c1-fed579ed4e09',
          title: 'CAC · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
          position: { layoutMode: PageLayoutTabLayoutMode.GRID, row: 0, column: 8, rowSpan: 2, columnSpan: 2 },
          configuration: {
            configurationType: 'AGGREGATE_CHART',
            aggregateFieldMetadataUniversalIdentifier: VYLINO_MARKETING_CAC_FIELD_ID,
            aggregateOperation: AggregateOperations.SUM,
            displayDataLabel: true,
            timezone: 'Asia/Kolkata',
            firstDayOfTheWeek: 1,
        ...
        {
          universalIdentifier: 'c55312f0-730f-4b0d-a33c-0f4e15df18bd',
          title: 'ROAS · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
          position: { layoutMode: PageLayoutTabLayoutMode.GRID, row: 0, column: 10, rowSpan: 2, columnSpan: 2 },
          configuration: {
            configurationType: 'AGGREGATE_CHART',
            aggregateFieldMetadataUniversalIdentifier: VYLINO_MARKETING_ROAS_FIELD_ID,
            aggregateOperation: AggregateOperations.SUM,
            displayDataLabel: true,
            timezone: 'Asia/Kolkata',
            firstDayOfTheWeek: 1,
        ...
        {
          universalIdentifier: '86a9870b-eb40-4422-9dbd-7f3169a23f82',
          title: 'Campaign spend · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
          ...
          configuration: {
            ...
            aggregateFieldMetadataUniversalIdentifier: VYLINO_MARKETING_SPEND_FIELD_ID,
            aggregateOperation: AggregateOperations.SUM,
            primaryAxisGroupByFieldMetadataUniversalIdentifier: VYLINO_MARKETING_CAMPAIGN_NAME_FIELD_ID,
            ...BAR,
            filter: marketing30DayCampaignFilter,
          },
        },
        {
          universalIdentifier: 'bf3b02a6-07f2-43a3-8f48-effe1aaa2867',
          title: 'Campaign leads · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
        ...
        {
          universalIdentifier: '9c190ab2-e11d-480c-9fef-a1e1eec48ba8',
          title: 'Campaign revenue · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
        ...
        {
          universalIdentifier: '41bbec53-0e70-4f36-9ba3-9a6a099982b3',
          title: 'Campaign ROAS · 30d',
          type: 'GRAPH',
          objectUniversalIdentifier: VYLINO_MARKETING_SNAPSHOT_OBJECT_ID,
