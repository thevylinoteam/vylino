...
const DEFAULT_SERVICES = [
  {
    ...
    shortDescription: 'Professional business websites, WordPress builds, landing pages and redesigns.',
    keywords: 'website,wordpress,business website,landing page,website redesign,web development',
    isActive: true,
  ...
  },
  {
    ...
    category: 'Ecommerce',
    shortDescription: 'Online stores using Shopify, WooCommerce or a suitable ecommerce stack.',
    keywords: 'ecommerce,e-commerce,online store,shopify,woocommerce,store website',
    isActive: true,
    paymentRequired: true,
    priority: 95,
  },
  {
    ...
    name: 'SEO Services',
    category: 'SEO',
    shortDescription: 'SEO strategy, on-page optimisation, local SEO and organic growth support.',
    keywords: 'seo,ranking,google ranking,organic traffic,search engine,local seo',
    isActive: true,
    paymentRequired: true,
    priority: 90,
  },
  {
    ...
    shortDescription: 'Integrated digital marketing for lead generation, content and growth.',
    keywords: 'digital marketing,online marketing,social media marketing,lead generation,content marketing',
    isActive: true,
    paymentRequired: true,
    priority: 85,
  },
  {
    ...
    shortDescription: 'Google Ads and Meta Ads campaign setup, optimisation and reporting.',
    keywords: 'google ads,meta ads,facebook ads,instagram ads,ppc,paid ads,advertising',
    isActive: true,
    paymentRequired: true,
    priority: 80,
  },
  {
    ...
    category: 'Support',
    shortDescription: 'Website updates, fixes, maintenance and ongoing technical support.',
    keywords: 'website maintenance,website support,website issue,wordpress support,website fix',
    isActive: true,
    paymentRequired: true,
    priority: 70,
  },
  ...
  private async request<T>(query: string, variables: Record<string, unknown>) {
    ...
    if (!response.ok || payload.errors?.length || !payload.data) {
      const message = payload.errors
        ...
        .filter(Boolean)
        .join('; ');
      throw new Error(message || `Twenty GraphQL request failed: ${response.status}`);
    }
    return payload.data;
  }
